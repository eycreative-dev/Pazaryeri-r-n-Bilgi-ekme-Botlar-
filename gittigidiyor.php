...
if (@$_POST["submit"]) {
	...
	$itemName = search('<meta property="og:image:alt" content="','"/>',$veri)[0];
	$itemPrice = search('<meta property="og:price:amount" content="','"/>',$veri)[0];
	$itemImg = search('<meta property="og:image" content="','"/>',$veri)[0];

}
?>
<hr>
<form action="" method="POST">
	<input type="text" name="kanalgir" placeholder="GittiGidiyor ürün bağlantısı">
